...
# Import routers
from app.api.v1 import polls, ballots, results, pairwise_ballots, exports, voters
...
app.include_router(pairwise_ballots.router, prefix="/api/v1/pairwise-ballots", tags=["pairwise-ballots"] )
